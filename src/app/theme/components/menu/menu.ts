...
export const verticalMenuItems = [ 
    ...
    new Menu (2, 'User KYC', '/pages/form-elements/UserKYC', null, 'magic', null, false, 0),
    ...
    new Menu (3, 'User Ticketing', '/pages/ticketing/UserTicket', null, 'magic', null, false, 0),
    ...
    new Menu (4, 'Admin KYC', '/pages/form-elements/AdminKYC', null, 'caret-right', null, false, 0),
    new Menu (5, 'Admin Ticketing', '/pages/ticketing/AdminTicket', null, 'caret-right', null, false, 0),
