...
export const verticalMenuItems = [ 
    ...
    new Menu (8, 'LongTerm', '/pages/package/LongTerm', null, 'keyboard-o', null, false, 6,'user'),
    new Menu (9, 'ShortTerm', '/pages/package/ShortTerm', null, 'keyboard-o', null, false, 6,'user'),
